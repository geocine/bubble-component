  ...
  render() {
    return (
      <div class="font-sans antialiased h-screen flex">
        ...
        {/* md:block */}
        <div class="bg-indigo-darkest text-purple-lighter flex-none p-4 hidden">
        ...
        <div class="bg-indigo-darker text-purple-lighter flex-none w-64 pb-6 hidden md:block">
          ...
          <div class="mb-8">
            ...
            <div class="flex items-center mb-3 px-4">
              <svg class="h-2 w-2 fill-current text-green mr-2" viewBox="0 0 20 20"><circle cx={10} cy={10} r={10} /></svg>
              <span class="text-white opacity-75">Aivan Monceller <span class="text-grey text-sm">(you)</span></span>
            </div>
            <div class="flex items-center mb-3 px-4">
              <svg class="h-2 w-2 fill-current text-green mr-2" viewBox="0 0 20 20"><circle cx={10} cy={10} r={10} /></svg>
              <span class="text-white opacity-75">Github</span>
            </div>
            <div class="flex items-center px-4 mb-6 opacity-50">
              <svg class="h-2 w-2 stroke-current text-white mr-2" viewBox="0 0 22 22"><circle cx={11} cy={11} r={9} fill="none" strokeWidth={3} /></svg>
              <span class="text-white">Stencil</span>
            </div>
          </div>
          <div class="hidden">
            <div class="px-4 mb-2 text-white flex justify-between items-center">
        ...
        <div class="flex-1 flex flex-col bg-white overflow-hidden">
          ...
          <div class="px-6 py-4 flex-1 overflow-y-scroll">
            ...
            <div class="flex items-start mb-4 text-sm">
              <img src="https://twitter.com/stenciljs/profile_image" class="w-10 h-10 rounded mr-3" />
              <div class="flex-1 overflow-hidden">
                <div>
                  <span class="font-bold">Stencil</span>
            ...
            {/* A message */}
            <div class="flex items-start mb-4 text-sm">
              <img src="https://twitter.com/aivandroid/profile_image" class="w-10 h-10 rounded mr-3" />
              <div class="flex-1 overflow-hidden">
                <div>
                  <span class="font-bold">Aivan Monceller</span>
            ...
            {/* A message */}
            <div class="flex items-start mb-4 text-sm">
              <img src="https://twitter.com/github/profile_image" class="w-10 h-10 rounded mr-3" />
              <div class="flex-1 overflow-hidden">
                <div>
                  <span class="font-bold">Github</span>
                  <span class="text-grey text-xs">12:46</span>
                </div>
                <p class="text-black leading-normal"><a href="#" class="inline-block bg-blue-lightest text-blue no-underline">@Aivan Monceller</a> the size of the generated CSS is creating a singularity in space/time, we must stop adding more utilities before it's too late!</p>
              </div>
            </div>
          </div>
