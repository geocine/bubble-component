import { Component, Element, Event, Prop, EventEmitter, Watch } from '@stencil/core';
  ...
  render() {
    return (
      <div class="flex rounded-lg border-2 border-grey overflow-hidden">
        ...
        <input type="text" class="w-full px-4" placeholder={this.placeholder} value={this.value} onInput={this.inputChanged.bind(this)} onKeyDown={this.inputSubmitted.bind(this)}/>
      </div>
    );
  }
}
